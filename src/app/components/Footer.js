      ...
      <div className="container mx-auto mb-24">
        ...
        >
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            {/* text */}
            <div className="text-secondary">Drive Dreams, Rent Reality</div>
            {/* phone & email */}
          ...
          <div className="flex-1">
            ...
            <div className="mb-9 text-secondary">
              Subscribe to our newsletter for exclusive car rental deals, your
              key to unlocking a world of road trip adventures!
            </div>
            {/* form */}
